                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-dark">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-success pull-right btn-xs" href="<?php echo $link ?>/Search"><i class='fa fa-search'></i></a>
                                                    ...
                                                    <div class="panel panel-default">                                                        
                                                        <div class="panel-body">                                                            
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">                                                                    
                                                                    <textarea rows='5' type="text" name="address" class="form-control" placeholder=". . ." autocomplete='off'></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Phone 1</label>
                                                                <div class="col-sm-9">                                                                    
                                                                    <input type="text" name="phone1" class="form-control" placeholder=". . ." autocomplete='off'>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Phone 2</label>
                                                                <div class="col-sm-9">                                                                    
                                                                    <input type="text" name="phone2" class="form-control" placeholder=". . ." autocomplete='off'>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Website</label>
                                                                <div class="col-sm-9">                                                                    
                                                                    <input type="text" name="website" class="form-control" placeholder=". . ." autocomplete='off'>
                                                                </div>
                                                            </div>                                                             
                                                        </div><!-- panel-body -->
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from supplier order by id desc");
                                            while ($row = mysql_fetch_array($query)) {
                                                $no++;
                                                ?>
                                                <tr>
                                                    <td class='text-center'><?php echo str_pad($row['id'], 5, '0', STR_PAD_LEFT) ?></td>  
                                                    <td><?php echo $row['name'] ?></td>
                                                    <td><?php echo $row['email'] ?></td>
                                                    <td>
                                                        <?php if ($row['phone1'] != "") echo "Phone 1 : " . $row['phone1'] . "<br>"; ?>
                                                        <?php if ($row['phone2'] != "") echo "Phone 2 : " . $row['phone2'] . "<br>"; ?>
                                                        <?php if ($row['address'] != "") echo nl2br("Address :\n" . $row['address']) . "<br>"; ?>
                                                        <?php if ($row['website'] != "") echo "Website : " . $row['website'] . "<br>"; ?>
                                                    </td>
                                                    <td class='text-center'>
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <a href=" <?php echo $link ?>/SupplierLog/<?php echo $row['id'] ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>                                        
                                                        </div>
                                                        <div class="btn-group" role="group" aria-label="...">
