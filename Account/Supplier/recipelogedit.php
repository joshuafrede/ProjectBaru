                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-dark">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-info pull-left btn-xs" href='<?php echo $link . "/" . $back ?>' style='margin-right: 5px'><i class='fa fa-arrow-left'></i></a>
...
<!--                                <a class="btn btn-info pull-right btn-xs"  data-toggle="modal" data-target="#bs-example-modal-lg"><i class='fa fa-plus'></i></a>                                -->
                            ...
                            <div class="panel-body">
                                <form id="basicForm" action="Edit/<?php echo nospace($nav) ?>/<?php echo nospace($nav_sub) ?>" class="form-horizontal" novalidate="novalidate" method='post'>
                                    <?php
                                    $query = mysql_query("select * from recipelog where id='$id'");
                                    ...
                                    <div class="panel panel-default">                                                        
                                        <div class="panel-body">       
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">                                                                    
                                                    <input type="text" name="amount" class="form-control" placeholder=". . ." required="" autocomplete='off' value='<?php echo $result['amount'] ?>'>
                                                </div>
                                            </div>                                                                                                                                                                                                                                                   
                                        </div><!-- panel-body -->
                                        <div class="panel-footer">
                                            <div class="row">
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    ...
                                                    <input type='hidden' name='url' value='<?php echo $link ?>/Edit/<?php echo $back ?>/<?php echo $id ?>/Success'>
                                                    <input type='hidden' name='url2' value='<?php echo $link ?>/Edit/<?php echo $back ?>/<?php echo $id ?>/Failed'>
