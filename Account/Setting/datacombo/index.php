                        ...
                        if (isset($status)) {
                            if ($status == "Success") {
                                ...
                                <div class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <strong>Add Failed</strong> Item already exits</a>.
                                </div>
                                <?php
                            }
                        }
                                                    ...
                                                    <div class="panel panel-default">    
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="value" class="form-control" placeholder=". . ." required="" autocomplete='off'>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Group</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="group" class="form-control" placeholder=". . ." autocomplete='off'>
                                                                </div>
                                                            </div>                                                                                                                                                                                    
                                                        </div><!-- panel-body -->
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from z_datacombo order by name,value asc");
                                                    ...
                                                    <td class='text-center'>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <form onsubmit="return confirm('Are you sure you want to Delete?');" method='post' action='Fungsi/globaldelete'>
                                                                ...
                                                                <input type='hidden' name='table' value='z_datacombo'>
