...
<!--                                <a class="btn btn-info pull-right btn-xs"  data-toggle="modal" data-target="#bs-example-modal-lg"><i class='fa fa-plus'></i></a>                                -->
                            ...
                            <div class="panel-body">
                                <form id="basicForm" action="Edit/<?php echo nospace($nav) ?>/<?php echo nospace($nav_sub) ?>" class="form-horizontal" novalidate="novalidate" method='post'>
                                    <?php
                                    $query = mysql_query("select * from z_module where id='$id'");
                                        ...
                                        <div class="panel panel-default">                                                        
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Sub Info <span class="asterisk">*</span></label>
                                                    <div class="col-sm-9">
                                                        <textarea rows="3" type="text" name="small_desc" class="form-control" placeholder=". . ." autocomplete='off'><?php echo $result['small_desc']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Information <span class="asterisk">*</span></label>
                                                    <div class="col-sm-9">
                                                        <textarea rows="3" type="text" name="desc" class="form-control" placeholder=". . ." autocomplete='off'><?php echo $result['desc']; ?></textarea>
                                                    </div>
                                                </div>                               
                                            </div><!-- panel-body -->
