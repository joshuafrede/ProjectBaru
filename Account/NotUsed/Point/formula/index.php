                                                                    ...
                                                                    <div class="col-sm-9" style='padding:0'>
                                                                        <div class="input-group mb15" style='padding-left: 10px'>
                                                                            ...
                                                                            while ($row = mysql_fetch_array($query)) {
                                                                                ?>
                                                                                <div class="checkbox block"><label><input type="checkbox" name='cardtype[]' value='<?php echo $row['id'] ?>' checked> <?php echo $row['name'] ?></label></div>
                                                                                <?php
                                                                            }
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from p_formula where merchant_id='" . $_SESSION['merchant'] . "' and deleted=0 order by name");
                                            while ($row = mysql_fetch_array($query)) {
                                                $no++;
                                                ?>
                                                <tr>
                                                    ...
                                                    <td class='text-center'>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <form onsubmit="return confirm('Are you sure you want to Delete?');" method='post' action='Fungsi/globalupdate'>
                                                                ...
                                                                <input type='hidden' name='table' value='p_formula'>
