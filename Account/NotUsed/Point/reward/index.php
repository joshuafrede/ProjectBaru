                                                ...
                                                <form id="basicForm" action="Add/<?php echo nospace($nav) ?>/<?php echo nospace($nav_sub) ?>" class="form-horizontal" novalidate="novalidate" method='post'>
                                                    <div class="panel panel-default">                                                        
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Max <span class="asterisk">*</span></label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="max" class="form-control" placeholder=". . ." required="" autocomplete='off' value='0'>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from p_reward where merchant_id='" . $_SESSION['merchant'] . "' and deleted=0 order by name");
                                                    ...
                                                    <td class='text-center'>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <form onsubmit="return confirm('Are you sure you want to Delete?');" method='post' action='Fungsi/globalupdate'>
                                                                ...
                                                                <input type='hidden' name='table' value='p_reward'>
