                                    ...
                                    <div class="panel panel-default">                                                        
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control datepicker" disabled placeholder="dd/mm/yyyy" name='date_from' required autocomplete='off' value='<?php echo $result['date_from'] ?>'>
                                                </div>                    
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">End Date <span class="asterisk">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control datepicker" disabled placeholder="dd/mm/yyyy"  name='date_to' required autocomplete='off' value='<?php echo $result['date_to'] ?>'>
                                                </div>                    
                                            </div>
                                            <div class="form-group">
