                                                ...
                                                <form id="basicForm" action="Add/<?php echo nospace($nav) ?>/<?php echo nospace($nav_sub) ?>" class="form-horizontal" novalidate="novalidate" method='post'>
                                                    <div class="panel panel-default">                                                        
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">PCAT ID <span class="asterisk">*</span></label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="pcat" class="form-control" placeholder=". . ." required="" autocomplete='off'>
                                                                </div>
                                                            </div>                                                            
                                                        </div><!-- panel-body -->
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from m_category order by id desc");
                                                    ...
                                                    <td class='text-center'>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <form onsubmit="return confirm('Are you sure you want to Delete?');" method='post' action='Fungsi/globaldelete'>
                                                                ...
                                                                <input type='hidden' name='table' value='m_category'>
