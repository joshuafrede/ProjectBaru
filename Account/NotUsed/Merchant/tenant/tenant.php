                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-dark">
                            <div class="panel-heading">
                                ...
                                <div class="modal fade bs-example-modal-lg in" id='bs-example-modal-lg' role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="false" enctype="multipart/form-data">
                                                    ...
                                                    <div class="panel panel-default">                                                        
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="cid" class="form-control" placeholder=". . ." required="" autocomplete='off'>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="contact" class="form-control" placeholder=". . ." required="" autocomplete='off'>
                                                                </div>
                                                            </div>                       
                                                            <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from m_tenant where merchant_id='" . $_SESSION['merchant'] . "' and deleted=0 order by id");
                                            while ($row = mysql_fetch_array($query)) {
                                                $no++;
                                                ?>
                                                <tr>
                                                    <td><?php echo $no ?></td>                                                    
                                                    <td><?php echo str_pad($no, 3, '0', STR_PAD_LEFT) ?></td>
                                                    ...
                                                    <td class='text-center'>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <form onsubmit="return confirm('Are you sure you want to Delete?');" method='post' action='Fungsi/globalupdate'>
                                                                ...
                                                                <input type='hidden' name='table' value='m_tenant'>
