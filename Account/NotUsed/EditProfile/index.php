...
<!--                                <a class="btn btn-info pull-right btn-xs"  data-toggle="modal" data-target="#bs-example-modal-lg"><i class='fa fa-plus'></i></a>                                -->
                            ...
                            <div class="panel-body">
                                <form id="basicForm" action="Edit/EditProfile/Merchant" class="form-horizontal" novalidate="novalidate" method='post' enctype="multipart/form-data">
                                    <?php
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <img src="<?php echo $result['pic2'] ?>" width="300">
                                                </div>
                                            </div>                                            
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Picture 1 & 2</label>
                                                <div class="col-sm-9">
                                                    <input type="file" name="mainpic" style="position: relative;top: 7px;display: inline;margin-right: 25px">
                                                    <input type="file" name="mainpic2" style="position: relative;top: 7px;display: inline">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="pmid" class="form-control" placeholder=". . ." autocomplete='off' value='<?php echo $result['pmerchant_id'] ?>'>
                                                </div>
                                            </div>  
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control btn-block" name='cardid' required style="border-left: 1px solid #ccc;border-radius: 3px">
                                                        ...
                                                        while ($row = mysql_fetch_array($query)) {
                                                            if ($result['cardid'] == $row['value']) {
                                                                echo "<option value='" . $row['value'] . "' selected>" . $row['value'] . " - " . $row['group'] . "</option>";
                                                            } else {
                                        ...
                                        <div class="panel-footer">
                                            <div class="row">
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    <input type='hidden' name='id' value='<?php echo $_SESSION['merchant'] ?>'>
