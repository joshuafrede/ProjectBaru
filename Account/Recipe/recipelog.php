                                                    ...
                                                    <div class="panel panel-default">                                                        
                                                        <div class="panel-body">  
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">                                                                    
                                                                    <select class="select2" name='recipe_id' required disabled>
                                                                        <?php
                                                                        $idsup = 0;
                                                                        $query = mysql_query("select * from recipe where id='$id' order by name");
                                                                    ...
                                                                    <input type='hidden' name='recipe_id' value='<?php echo $idsup; ?>'>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Item<span class="asterisk">*</span></label>
                                                                <div class="col-sm-9">                                                                    
                                                                    <select class="select2" multiple name='product_id[]' data-placeholder="Choose an Item" required>                                                                        
                                                                        <?php
                                                                        $query = mysql_query("select * from product order by name");
                                                                        while ($row = mysql_fetch_array($query)) {
                                                                            $querydalem = mysql_query("select * from recipelog where recipe_id='$idsup' and product_id='" . $row['id'] . "'");
                                    ...
                                    <table class="table mb40 table-bordered" id='table1'>
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Name</th>
                                                <th class="text-center" style="width: 205px">Qty</th>
                                                        ...
                                                        <div class="panel panel-default">                                                        
                                                            <div class="panel-body">                                                                                                                        
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label">Item<span class="asterisk">*</span></label>
                                                                    <div class="col-sm-9">                                                                    
                                                                        <select class="select2" name='product_id[]' multiple data-placeholder="Choose an Sub recipe"  required>
                                                                            <?php
                                                                            $query = mysql_query("select * from recipe where subrecipe=0 order by name");
                                                                            while ($row = mysql_fetch_array($query)) {
                                                                                $querydalem = mysql_query("select * from subrecipelog where recipe_id='$idsup' and subrecipe_id='" . $row['id'] . "'");
                                                                                if (mysql_num_rows($querydalem) == 0) {
                                                                                    echo "<option value='" . $row['id'] . "'>" . $row['name'] . "</option>";
                                                                                }
                                                                            }
