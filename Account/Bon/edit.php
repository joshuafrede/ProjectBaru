                                    ...
                                    <div class="panel panel-default">                                                        
                                        <div class="panel-body">                                                                                        
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control datepicker" placeholder="dd-mm-yyyy"  name='date' value='<?php echo date("d-m-Y", strtotime($result['name'])); ?>' required autocomplete='off'>
                                                </div>                    
                                            </div>                                                                                                                                                                                                                                                
                                        </div><!-- panel-body -->
