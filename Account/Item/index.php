                                                    ...
                                                    <div class="panel panel-default">                                                        
                                                        <div class="panel-body">         
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">                                                                    
                                                                    <input type="text" name="buffer" class="form-control" value="1" placeholder=". . ." required="" autocomplete='off'>
                                                                </div>
                                                            </div>                                                                                                                     
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label">Buffer Kitchen <span class="asterisk">*</span></label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="buffer_kitchen" class="form-control" value="1" placeholder=". . ." required="" autocomplete='off'>
                                                                </div>
                                                            </div>                                                                                                                                                                                                                                   
                                                        </div><!-- panel-body -->
                                ...
                                <div class="table-responsive">
                                    <table class="table mb40 table-bordered" id='table1'>
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 0;
                                            $query = mysql_query("select * from product where belong like '%$filter%' order by updated_at desc");
                                            while ($row = mysql_fetch_array($query)) {
                                                $no++;
                                                ?>
                                                <tr>
                                                    <td><?php echo $no ?></td>                                                    
                                                    <td><?php echo $row['belong'] ?></td>
