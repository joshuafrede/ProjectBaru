                                    ...
                                    <div class="panel panel-default">                                                        
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control btn-block" name='category' required style="border-left: 1px solid #ccc;border-radius: 3px" disabled>
                                                        <option value="">. . .</option>
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="username" class="form-control" placeholder=". . ." required="" autocomplete='off' value='<?php echo $result['username'] ?>' disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="pmid" class="form-control" placeholder=". . ." autocomplete='off' value='<?php echo $result['pmerchant_id'] ?>' disabled>
                                                </div>
                                            </div>                                            
                                        </div><!-- panel-body -->
